...
def features2(sent, context_size=3, undefined='__'):
    """
    Example of a simple feature function which generates, for each token in
    the sentence, its lemma, POS and first hypernym of the first Wordnet synset of the first hypernym as well as that of the three
    preceding/following tokens (i.e. window size=7).
    ...
    [
    {
      ...
      "3:lemma": "be",
      "3:pos": "VERB",
      "3:wnhypernym3": "Synset('substance.n.01')"
    },
    {
      "-1:lemma": "poor",
      "-1:pos": "ADJ",
    ...
    },
    {
      ...
      "-2:lemma": "poor",
      "-2:pos": "ADJ",
      "-2:wnhypernym3": "Synset('abstraction.n.06')",
      "-3:lemma": "__",
      "-3:pos": "__",
      "-3:wnhypernym3": "__",
      "0:lemma": "behavior",
      ...
      "3:lemma": "major",
      "3:pos": "ADJ",
      "3:wnhypernym3": "Synset('military_officer.n.01')"
    },
